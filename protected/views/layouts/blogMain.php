        ...
        <div id="bootstrap-container" class="container">
            ...
            <div id="header-logo-row" class="row">
                ...
                <div class="col-md-9">
                    ...
                    <a id="logo-anchor" href="<?php echo MEDINFI_FOLDER_BASE_URL . "/" ?>"
                       onclick="ga('send', {hitType: 'event',eventCategory:'<?php echo $layoutData['pageName'] ?>', eventAction: 'Home',eventLabel: 'Home'});">
                        <img id="medinfi-logo"
